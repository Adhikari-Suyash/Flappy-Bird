...
def mainGame():
    ...
    while True:
        ...
        SCR.blit(GAME_SPRITES['background'], (0, 0))
        for upperPipe, lowerPipe in zip(upperPipes, lowerPipes):
            SCR.blit(GAME_SPRITES['pipe'][0], (upperPipe['x'], upperPipe['y']))
            SCR.blit(GAME_SPRITES['pipe'][1], (lowerPipe['x'], lowerPipe['y']))
        ...
        for digit in myDigits:
            SCR.blit(GAME_SPRITES['numbers'][digit], (Xoffset, SCRHT*0.12))
